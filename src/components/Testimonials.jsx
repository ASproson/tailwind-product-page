  ...
  return (
    <div>
      <section id="testimonials">
        <div className="max-w-6xl0 px-5 mx-auto mt-32 text-center">
          <h2 className="h2 text-4xl font-bold text-center">
          ...
          <div className="flex flex-col mt-24 md:flex-row md:space-x-6">
            ...
            <div className="flex flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:w-1/3">
              ...
              <p className="text-sm text-darkGrayishBlue italic">
            ...
            <div className="hidden flex-col items-center p-6 space-y-6 rounded-lg bg-veryLightGray md:w-1/3 md:flex">
              ...
              <h5 className="text-lg font-bold">Ali Saint</h5>
              <p className="text-sm text-darkGrayishBlue italic">
